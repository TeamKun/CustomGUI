...
fun <T> List<T>.joinTo(toIndex: Int, separator: String = " ") = limit(0, toIndex).joinToString(separator)
fun <T> List<T>.joinFrom(fromIndex: Int, separator: String = " ") = limit(fromIndex, 0).joinToString(separator)